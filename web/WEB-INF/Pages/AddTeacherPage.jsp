					...
					<h1>添加老师</h1>
						<div class="bann-main">
							...
							<form action="AddTeacher"  method="get">
								<div>
									<label style="color: white; font-size: 22px;">输入要添加的老师名称:</label>
									<input
											type="text" name="id"
								...
								<div>
									<label style="color: white; font-size: 22px;">输入要添加的老师账号:</label>
									<input 
										type="text" name="id"
										style="font-size: 22px; background-color: transparent; border: none; border-bottom: 1px solid white; line-height: 1em; margin-bottom: 20px; color:white;">
								</div>
								<div>
									<label style="color: white; font-size: 22px;">输入要添加的老师密码:</label>
									<input
											type="password" name="psd"
											style="font-size: 22px; background-color: transparent; border: none; border-bottom: 1px solid white; line-height: 1em; margin-bottom: 10px; color:white;">
								</div>
