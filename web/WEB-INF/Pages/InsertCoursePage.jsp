					...
					<h1>课程添加</h1>
						<div class="bann-main">
							...
							<form action="InsertCourseServlet"  method="get">
								<div>
									<label style="color: white; font-size: 22px;">&nbsp&nbsp&nbsp&nbsp课程名&nbsp&nbsp&nbsp&nbsp&nbsp:</label> 
									<input 
										type="text" name="name"
								...
								<div>
									<label style="color: white; font-size: 22px;">授课老师账号:</label>
									 <input 
										type="text"  name="tecId"
										style="font-size: 22px; background-color: transparent; border: none; border-bottom: 1px solid white; line-height: 1em; margin-bottom: 20px; color:white;">
								</div>
								<input type="submit" value="确定添加" style="background-color: #ff4f81; border: none; border-radius: 5px; font-size: 22px; color: white; margin: 10px;">
