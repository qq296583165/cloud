							...
							<c:if test='${student!=null}'>
								<div>
									...
									<input 
										...
										disabled="disabled";  value="${student.name }"  onfocus="this.value=''">
								</div>
								<div>
									<label style="color: white; font-size: 22px;">账号:</label>
									 <input 
										type="text" name="id"
										style=" text-align: center; font-size: 22px; background-color: transparent; border: none; border-bottom: 1px solid white; line-height: 1em; margin-bottom: 20px; color:white;"
										disabled="disabled" value="${student.id }"  onfocus="this.value=''">
								</div>
								...
								<div>
									...
									<input class="in"
										type="text" name="pass"
										style="text-align: center; font-size: 22px; background-color: transparent; border: none; border-bottom: 1px solid white; line-height: 1em; margin-bottom: 20px; color:white;"
										disabled="disabled" value="******"  onfocus="this.value=''">
								</div>
								<div >
									<label style="color: white; font-size: 22px;"> 成绩:
									<input class="in"
										type="text" name="grade"
										style="text-align: center; font-size: 22px; background-color: transparent; border: none; border-bottom: 1px solid white; line-height: 1em; margin-bottom: 20px; color:white;"
										disabled="disabled" value="${Grade }"  onfocus="this.value=''">分
										</label> 
								</div>
								<div>
									...
									<input 
										type="text" name="tel"
										style="text-align: center; font-size: 22px; background-color: transparent; border: none; border-bottom: 1px solid white; line-height: 1em; margin-bottom: 20px; color:white;"
										disabled="disabled" value="${student.tel}"  onfocus="this.value=''">
								</div>
								<div>
									<label style="color: white; font-size: 22px;">性别:</label>
									 <input 
										type="text" name="sex"
										style="text-align: center; font-size: 22px; background-color: transparent; border: none; border-bottom: 1px solid white; line-height: 1em; margin-bottom: 20px; color:white;"
										disabled="disabled" value="${student.sex}"  onfocus="this.value=''">
								</div>
								<button type="button"  style="background-color: #ff4f81; border: none; border-radius: 5px; font-size: 22px; color: white; margin: 10px;" onclick="changeType()" >
								修改</button>
								...
								function submitInput(){
									...
									$.post("GradeUpdate",{"grade":grade,"pass":pass}); 
								}
								</script>
								</c:if>
